...
public class PullToReloadListView extends ListView implements OnScrollListener {
	// 状态
    ...
    public PullToReloadListView(Context context) {
        super(context);
        init(context);
    }

    public PullToReloadListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PullToReloadListView(Context context, AttributeSet attrs, int defStyle) {
